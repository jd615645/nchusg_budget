...
BubbleTree.Utils.formatNumber = function(n) {
  ...
  if (n >= 1000000000) return prefix+Math.round(n / 100000000)/10 + '億';
  if (n >= 10000) return prefix+Math.round(n / 1000)/10 + ' 萬';
  if (n >= 1000) return prefix+Math.round(n / 100)/10 + ' 千';
